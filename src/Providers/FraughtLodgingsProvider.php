...
class FraughtLodgingsProvider implements Provider
{
    private string $name = 'Fraught Lodgings';
    private string $source = './data/fraught-lodgings.json';
    /**
     * @var Room[]
     */
    private array $rooms = [];
    ...
    {
        return $fare->getPrice() - 0.05 * $fare->getPrice();
    }
}